...
func (c *authServiceClient) Signup(ctx context.Context, in *SignupRequest, opts ...grpc.CallOption) (*NewUserResponse, error) {
...
func (UnimplementedAuthServiceServer) Signup(context.Context, *SignupRequest) (*NewUserResponse, error) {
